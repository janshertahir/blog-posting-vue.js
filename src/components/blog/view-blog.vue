...
<div v-else class="container">
    ...
    <div class="cs-blog-detail">
        <div class="cs-main-post" v-if="blog.image">
            <figure><img alt="None" :src=blog.image></figure>
        </div>
        <div>
            <h1>{{blog.title}}</h1>
        </div>
        <div class="cs-post-title">
            ...
            <div class="post-option">
                ...
                <span class="post-date"><a><i class="cs-color icon-calendar6"></i>{{blog.date}}</a></span>
            </div>
        </div>
        ...
        <div class="cs-tags">
            <div class="tags">
                <span>Blog Catergory</span>
                <ul>
                    <li><a rel="tag">{{blog.category}}</a></li>
                </ul>
            </div>
